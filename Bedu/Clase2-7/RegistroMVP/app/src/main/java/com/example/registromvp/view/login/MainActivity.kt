...
import com.example.registromvp.presenter.login.LoginPresenter
import com.example.registromvp.presenter.login.LoginPresenterImp
import com.example.registromvp.view.usuarios.UsuariosRegistrados
...
class MainActivity : AppCompatActivity(),
    ...
    override fun onLoginExist() {
        val intent: Intent = Intent(applicationContext, UsuariosRegistrados::class.java)
